...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_MarginWidget_t, stringdata0) + ofs \
...
QT_INIT_METAOBJECT const QMetaObject MarginWidget::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_MarginWidget.data,
    qt_meta_data_MarginWidget,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *MarginWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_MarginWidget.stringdata0))
