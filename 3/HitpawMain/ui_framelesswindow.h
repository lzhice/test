...
"}"));
        ...
        windowTitlebar->setStyleSheet(QString::fromUtf8("#windowTitlebar{border: 0px none palette(base); border-top-left-radius:10px; border-top-right-radius:10px; background-color:palette(shadow); height:20px;}"));
