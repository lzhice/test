...
void DarkStyle::polish(QPalette &palette) {
  ...
  palette.setColor(QPalette::Shadow, QColor("#2E2F30"));
  ...
  palette.setColor(QPalette::Highlight, QColor(42, 42, 42,12));
  palette.setColor(QPalette::Disabled, QPalette::Highlight, QColor(180, 80, 80));
